...
output "vpc_cidr_block" {
  ...
  value       = "${module.dev.vpc_cidr_block}"
}

output "vpc_instance_tenancy" {
  description = "Tenancy of instances spin up within VPC."
  value       = "${module.dev.vpc_instance_tenancy}"
}

output "vpc_enable_dns_support" {
  description = "Whether or not the VPC has DNS support."
  value       = "${module.dev.vpc_enable_dns_support}"
}

output "vpc_enable_dns_hostnames" {
  description = "Whether or not the VPC has DNS hostname support."
  value       = "${module.dev.vpc_enable_dns_hostnames}"
}

output "vpc_enable_classiclink" {
  description = "Whether or not the VPC has Classiclink enabled."
  value       = "${module.dev.vpc_enable_classiclink}"
}

output "vpc_multi_tier" {
  description = "Whether or not the VPC has Multi Tier subnets."
  value       = "${module.dev.vpc_multi_tier}"
}

output "vpc_main_route_table_id" {
  description = "The ID of the main route table associated with this VPC."
  value       = "${module.dev.vpc_main_route_table_id}"
}

output "vpc_default_network_acl_id" {
  description = "The ID of the network ACL created by default on VPC creation."
  value       = "${module.dev.vpc_default_network_acl_id}"
}

output "vpc_default_security_group_id" {
  description = "The ID of the security group created by default on VPC creation."
  value       = "${module.dev.vpc_default_security_group_id}"
}

output "vpc_default_route_table_id" {
  description = "The ID of the route table created by default on VPC creation."
  value       = "${module.dev.vpc_default_route_table_id}"
}

output "subnet_public_ids" {
  description = "List of IDs of public subnets."
  value       = "${module.dev.subnet_public_ids}"
}

output "subnet_public_cidr_blocks" {
  description = "List of cidr_blocks of public subnets."
  value       = "${module.dev.subnet_public_cidr_blocks}"
}

output "subnet_app_ids" {
  description = "List of IDs of app subnets."
  value       = "${module.dev.subnet_app_ids}"
}

output "subnet_app_cidr_blocks" {
  description = "List of cidr_blocks of app subnets."
  value       = "${module.dev.subnet_app_cidr_blocks}"
}

output "subnet_data_ids" {
  description = "List of IDs of data subnets."
  value       = "${module.dev.subnet_data_ids}"
}
